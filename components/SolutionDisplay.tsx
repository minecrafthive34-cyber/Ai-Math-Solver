...
import { SolutionResponse, SolutionStatus } from '../types';
...
const SolutionDisplay: React.FC<SolutionDisplayProps> = ({ solution, isLoading, error }) => {
    const { t } = useLanguage();
        ...
        return (
            <div className="animate-fade-in text-start">
                <div className="flex justify-between items-start mb-4 gap-4">
                    ...
                    <span className={`px-3 py-1 text-sm font-semibold rounded-full ${statusBg} flex-shrink-0`}>
                        {statusText}
                    </span>
                </div>
