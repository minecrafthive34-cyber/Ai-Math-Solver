...
const FactOfTheDay: React.FC<FactOfTheDayProps> = ({ fact, isLoading }) => {
  ...
  return (
    <div className="mt-6 p-4 bg-blue-50 dark:bg-gray-800 border border-blue-200 dark:border-gray-700 rounded-lg shadow-md">
      ...
      {isLoading ? (
        ...
        <p className="text-gray-700 dark:text-gray-300 text-start">{fact}</p>
      )}
    </div>
  );
};
